...
INSERT INTO `user` (`user_id`, `user_name`, `user_password`, `user_role`, `user_mobile`, `user_email`, `user_address`)
VALUES (1, 'JohnDoe', 'pass123', 'admin', '555-1234', 'john.doe@example.com', '123 Main St'),
