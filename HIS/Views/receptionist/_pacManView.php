...
<body>
                    ...
                    <tbody>
                        <?php foreach ($rows as $row) { ?>
                            <tr id="row_<?php echo $row['patient_id']; ?>">
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info" onclick="openUpdateModal(<?php echo $row['patient_id']; ?>, '<?php echo $row['user_id']; ?>',
                                     '<?php echo $row['first_name']; ?>','<?php echo $row['last_name']; ?>', '<?php echo $row['date_of_birth']; ?>', 
                                    '<?php echo $row['gender']; ?>', '<?php echo $row['phone_number']; ?>', '<?php echo $row['email']; ?>', '<?php echo $row['street']; ?>',
                                     '<?php echo $row['city']; ?>', '<?php echo $row['post_code']; ?>')">
                                        <i class="material-icons">&#xE8B8;</i>
                                    </button>
                                    <a href="#" class="btn btn-sm btn-info delete" title="Delete" data-toggle="tooltip" data-user-id="<?php echo $row['patient_id']; ?>"><i class="material-icons">&#xE5C9;</i></a>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                            <label for="updateUsername">Patient id</label>
                            <input type="text" class="form-control" id="updatePatientId" name="updatePatientId" readonly>
    ...
    <script>
        ...
        function openUpdateModal(patientId, userId, firstname, lastname, birthday, gender, phone, email, street, city, postcode) {
            ...
            document.getElementById("updateBirthdate").value = birthday;
    ...
    <div class="bg-modal">
        <div class="modal-contents">
            ...
            <form action="recPatientMan.php" method="post" class="bg-form">                  
                        <div class="form-group">
                            <label for="updateUsername">User id</label>
                            <input type="text" class="form-control" id="updateUserId" name="updateUserId" required>
                        </div>
